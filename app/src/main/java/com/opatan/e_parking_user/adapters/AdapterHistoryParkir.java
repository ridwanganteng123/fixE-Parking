...
//        holder.pemeriksa.setText("Anda Diperiksa Oleh " + dataHistoryParkir.getPemeriksa());
    ...
    public static class AdapterHistoryParkirView extends RecyclerView.ViewHolder{

        public TextView waktu_masuk, pemeriksa, tanggal;

        public AdapterHistoryParkirView(@NonNull View itemView) {
            super(itemView);

            waktu_masuk = itemView.findViewById(R.id.waktu);
            pemeriksa = itemView.findViewById(R.id.pemeriksa);
